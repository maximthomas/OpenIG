...
. Download and run the minimal https://repo1.maven.org/maven2/org/openidentityplatform/openig/openig-doc/5.2.4/openig-doc-5.2.4-jar-with-dependencies.jar[HTTP server .jar] to use as the application to protect:
